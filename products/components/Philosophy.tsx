  ...
  return (
    <section id="philosophy" className="py-40 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-[-20%] left-[20%] w-[60%] h-[60%] bg-gray-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>

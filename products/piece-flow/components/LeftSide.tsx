  ...
  return (
    <aside className="hidden lg:flex flex-col justify-between w-full h-screen sticky top-0 py-12 px-8 border-r border-gray-100/50 relative overflow-hidden z-40">
      ...
      <div className="relative z-10">
        <a 
          href="/" 
          className="block w-24 opacity-90 hover:opacity-100 transition-opacity drop-shadow-sm"
          aria-label="Back to Home"
        >
          {/* Using dark logo for lighter theme */}
          <img src="assets/logo.png" alt="Puzzle" className="w-full h-auto" />
        </a>
      </div>

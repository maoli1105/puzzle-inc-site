...
const MouseStalker: React.FC = () => {
  ...
  return (
    <div
      ref={stalkerRef}
      className={`hidden lg:hidden lg:flex fixed top-0 left-0 pointer-events-none z-[9999] rounded-full bg-white mix-blend-difference transition-all duration-300 ease-out will-change-transform items-center justify-center`}
      style={{

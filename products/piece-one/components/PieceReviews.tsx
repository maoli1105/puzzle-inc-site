...
const reviews: Review[] = [
  {
    quote: "ケーブル一本で、思考のノイズが消えた。デスクにおける「禅」のような存在。",
    author: "K. Sato",
    title: "Architect"
  },
  {
    quote: "ただの充電器具ではない。空間を構成するインテリアの一部として成立している。",
    author: "M. Tanaka",
    title: "Interior Designer"
  },
  {
    quote: "持ち歩くとき、カバンの中で絡まないことがこれほどストレスフリーだとは。",
    author: "Y. Suzuki",
    title: "Photographer"
  }
];
        ...
        <div className="grid grid-cols-1 gap-12">
            {reviews.map((review, index) => (
                <ScrollReveal key={index} delay={index * 100} className="relative group cursor-default">
                    <div className="relative p-8 md:p-12 bg-gray-50 rounded-2xl transition-all duration-500 hover:shadow-xl hover:bg-white border border-transparent hover:border-gray-100">
                        {/* Quote Icon */}
                        <div className="absolute top-8 left-8 text-6xl text-gray-200 font-serif opacity-50 group-hover:text-blue-100 transition-colors">“</div>
                        ...
                        <blockquote className="relative z-10 text-center">
                            ...
                            <footer className="flex flex-col items-center">
                                <div className="w-8 h-px bg-gray-300 mb-4 group-hover:w-16 transition-all duration-500"></div>
